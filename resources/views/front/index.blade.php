...
<!-- Graph CSS -->
<link rel="stylesheet" href="{{ asset('plugins/modern-admin/css/lines.css')}}">
<link rel="stylesheet" href="{{ asset('plugins/modern-admin/css/font-awesome.css')}}">
<!-- jQuery -->
...
<!---//webfonts--->  
<!-- Nav CSS -->
<link href="{{ asset('plugins/modern-admin/css/custom.css')}}">
     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">{{ Auth::user()->nombre }}</a>
            </div>
            <!-- /.navbar-header -->
            <ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="avatar">
							<a href="#">
								<img src="{{ asset('plugins/modern-admin/images/1.png')}}">
								<div>New message</div>
						...
						<li class="avatar">
							<a href="#">
								<img src="{{ asset('plugins/modern-admin/images/2.png')}}">
								<div>New message</div>
								<small>1 minute ago</small>
								<span class="label label-info">NEW</span>
							</a>
						...
						<li class="avatar">
							<a href="#">
								<img src="{{ asset('plugins/modern-admin/images/3.png')}}" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="{{ asset('plugins/modern-admin/images/4.png')}}" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="{{ asset('plugins/modern-admin/images/5.png')}}" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="{{ asset('plugins/modern-admin/images/pic1.png')}}" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
			    ...
			    <li class="dropdown">
	        		<a href="#" class="dropdown-toggle avatar" data-toggle="dropdown"><img src="{{ asset('plugins/modern-admin/images/1.png')}}"><span class="badge">9</span></a>
	        		<ul class="dropdown-menu">
						...
						<li class="m_2"><a href="#"><i class="fa fa-lock"></i><a href="{{ route('front.auth.logout') }}"> Logout</a></li>	
	        		</ul>
	      		</li>
			</ul>
		       ...
		       <div class="activity_box">
		        <div class="scrollbar" id="style-2">
                   <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src="{{ asset('plugins/modern-admin/images/5.png')}}" class="img-responsive" alt=""/></div>
	                 ...
	                 <div class="col-xs-3 activity-img"><img src="{{ asset('plugins/modern-admin/images/3.png')}}" class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src="{{ asset('plugins/modern-admin/images/1.png')}}" class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row1">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src="{{ asset('plugins/modern-admin/images/4.png')}}" class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
	  ...
	  <div class="span_11">
		<div class="col-md-6 col_4">
		  ...
		  <!----Calender -------->
			<link rel="stylesheet" href="{{ asset('plugins/modern-admin/css/clndr.css')}}">
			<script src="{{ asset('plugins/modern-admin/js/underscore-min.js')}}" type="text/javascript"></script>
			<script src= "{{ asset('plugins/modern-admin/js/moment-2.2.1.js')}}" type="text/javascript"></script>
			<script src="{{ asset('plugins/modern-admin/js/clndr.js')}}" type="text/javascript"></script>
			<script src="{{ asset('plugins/modern-admin/js/site.js')}}" type="text/javascript"></script>
			<!----End Calender -------->
		</div>
...
var detail = new Rickshaw.Graph.HoverDetail({
	graph: graph
	      ...
	      <!-- map -->
<link href="{{ asset('plugins/modern-admin/css/jqvmap.css')}}" rel='stylesheet' type='text/css' />
<script src="{{ asset('plugins/modern-admin/js/jquery.vmap.js')}}"></script>
<script src="{{ asset('plugins/modern-admin/js/jquery.vmap.sampledata.js')}}" type="text/javascript"></script>
<script src="{{ asset('plugins/modern-admin/js/jquery.vmap.world.js')}}" type="text/javascript"></script>
