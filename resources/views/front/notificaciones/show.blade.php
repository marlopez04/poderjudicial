...
<!-- comentarios -->
              ...
              @foreach($notificacion->notificacioncomentarios as $comentario)
<!--                      <div> -->
...
<!-- comentarios -->                      
{!! Form::open(['route' =>['notificacioncomentarios.update', $notificacion->id], 'method' => 'PUT']) !!}
